...
#include "ValvanoWare/CortexM.h"
#include "ValvanoWare/PLL.h"
#include "ValvanoWare/LaunchPad.h"
#include "ValvanoWare/Timer4A.h"
#include "ValvanoWare/WTimer0A.h"
...
// NOTE: fgetc/fputc don't seem to be used by newlib with GCC (see _write/_read below)
...
//************** libc system calls *************** 
// From https://interrupt.memfault.com/blog/boostrapping-libc-with-newlib
extern int _end;
...
int _write (int file, char * ptr, int len) {
  ...
  } else if(StreamToDevice == 1) {
    // Output to file
    for (; len != 0; --len) {
      if(eFile_Write(*ptr++)){  // close file on error
        OS_EndRedirectToFile(); // cannot write to file
